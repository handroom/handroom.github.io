...
본업 있는 개발자. 퇴근 후에 뭔가를 만든다.

지금은 게임을 만들고 있다. 게임은 처음 만든다. AI랑 같이 만든다.

만드는 과정을 여기 기록한다. 잘 되는 것보다 안 되는 게 많아서 쓸 게 많다.

글은 작업 로그에서 나온다. 지어내지 않는다.
...
데이터는 전부 기기 안에만 있다. 계정도 서버도 없다.

성적은 [부검 시리즈](/posts/daysplus-postmortem-1/)에 숫자 그대로 적어놨다. 다운로드도 매출도 숨기지 않았다.
