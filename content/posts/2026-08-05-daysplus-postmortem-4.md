...
개발 15일차에 물어본 게 개인사업자로 개발자 계정을 만드는 절차였다. 앱을 스토어에 올리려면 나를 증명해야 하고, 그 증명이 사업자 등록에서 시작된다는 걸 그때 알았다.
...
스토어에 적는 연락처가 앱 정보에 그대로 공개된다는 것도 2월에 알았다. 내 번호가 스토어에 박히는 게 싫어서 20분 뒤엔 070 번호를 어떻게 개설하는지 찾고 있었다. 비즈니스 메일도 같이 알아봤다. 2월 27일엔 도메인을 샀다.

그러고도 3월 19일에 플레이 콘솔 전화번호 인증 문자가 안 와서 며칠 막혔다.
...
이건 4월 18일 오후에 뜬 거다. 세로 방향만 지원한다고 적어놨는데, 아이패드 멀티태스킹을 지원하려면 가로 두 방향까지 네 개를 다 선언해야 한다는 얘기다. 앱은 아무 문제 없이 돌아가고 있었다. 스토어가 요구하는 칸을 안 채웠을 뿐이다.

이런 걸 며칠 반복하다 그날 오후에 남긴 말이 "지긋지긋하다..." 였다.
