...
여기에 하나가 더 걸렸다. Days+는 서버를 안 쓴다. 데이터가 전부 기기 안에만 있게 만들어놨는데, 그러면 위젯에 사진 한 장 넘기는 것도 기기 안에서 파일을 복사하고 크기를 줄이고 캐시를 관리하는 일이 된다. 서버가 있으면 주소 하나 던지고 끝날 일이다. 편한 길을 스스로 막아놓고 시작한 셈이다.
